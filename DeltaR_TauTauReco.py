...
def main():
    ...
    hists=[
    'RECO/h1_deltaRTauTauReco_selEvt',
    ]
    ...
    xranges={
        "RECO/h1_deltaRTauTauReco_selEvt":[0,2.0],    
    }
 ...
 #       test.Add_plot('Signi',pos=2, height=12)
        ...
        if hist in xranges.keys():
            test.Set_axis(logx=False,logy=True,xmin=xranges[hist][0],xmax=xranges[hist][1],ymin=1e-6,ymax=1e6)
