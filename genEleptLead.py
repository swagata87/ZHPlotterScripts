...
def main():
    ...
    xranges={
     "GEN/h1_Gen_EleFromZ_Pt_Lead":[0,800],    
    }
 ...
 #       test.Add_plot('Signi',pos=2, height=12)
        ...
        if hist in xranges.keys():
            #test.Set_axis(logx=False,logy=False,xmin=xranges[hist][0],xmax=xranges[hist][1],ymin=1e-6,ymax=1e9)
